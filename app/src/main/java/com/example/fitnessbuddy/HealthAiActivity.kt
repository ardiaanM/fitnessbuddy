...
import com.example.fitnessbuddy.databinding.ActivityHealthaiBinding
import okhttp3.*
...
class HealthAiActivity : AppCompatActivity() {
    private val client = OkHttpClient()
    private val answerList = mutableListOf<String>() // List to store the answers
    private lateinit var txtResponse: TextView
    private lateinit var binding: ActivityHealthaiBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHealthaiBinding.inflate(layoutInflater)
